...
python ./argoverse-api/argoverse/evaluation/eval_tracking.py \
        --path_tracker_output /Users/yuqingz/Documents/Argo/argoverse_cbgs_kf_tracker/temp_files/train-split-track-preds-maxage15-minhits5-conf0.3 \
        --path_dataset /Users/yuqingz/Documents/Argo/argoverse-tracking/train4 \
        --d_max 100
